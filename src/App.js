...
import {FeedBackPage} from "./components/common/ConnectPage/FeedBackPage";
  ...
  return (
    <div className={`theme`}>
      ...
      <Switch location={location}>
        ...
        <AuthorizedRoute path={Routes.FeedbackPage} component={FeedBackPage} isAuthorized={isAuthorized} withNavigation/>
