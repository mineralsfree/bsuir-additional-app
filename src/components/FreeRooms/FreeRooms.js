  ...
  return (<div className={roomsCN('container')}>
    <Form variant="flat" className={roomsCN('form')} onSubmit={(e) => {
      ...
      <div className={roomsCN('housing-input')}>
        <div className={roomsCN('dropdown-container')}>
          <MyDropdown items={Object.keys(buildingMock())}
                      capture={'Номер корпуса'} onChange={(e) => {
            setForm({
              ...formData,
        ...
        <div className={roomsCN('dropdown-container')}>
          ...
          <MyDropdown capture={'Этаж'} items={formData.floorOptions}/></div>
        <div className={roomsCN('dropdown-container')}>

          <MyDropdown capture={'Пара'} items={lessons}/></div>
